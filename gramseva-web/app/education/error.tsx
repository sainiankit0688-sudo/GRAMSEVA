  ...
  return (
    <div className="min-h-full bg-[#F5F5F5] flex items-center justify-center px-4" role="alert">
      <div className="text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-800 mt-4">Education Service Error</h1>
        <p className="text-sm text-gray-500 mt-2">शिक्षा सेवा में त्रुटि</p>
        <p className="text-xs text-gray-400 mt-1 max-w-xs mx-auto">
          {error.message || 'Failed to load education data. Please try again.'}
        </p>
        <button
          onClick={reset}
